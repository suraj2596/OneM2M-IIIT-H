...
void loop() {
  ...
  createCI("Automated_Driving","speed",String(sensor1));
  createCI("Automated_Driving","distance",String(sensor2));
  createCI("Automated_Driving","temperature",String(sensor3));
